...
![](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/13422/1.png)
...
이 문제는 투 포인터를 이용해서 풀 수 있었다. 다만 원형이라는 특수 형태이기 때문에 N과M이 같을 때는 도둑질을 하는 방법이 하나라는 걸 알아야 한다. 
